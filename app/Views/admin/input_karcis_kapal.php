...
<head>
    ...
    <title>Input Karcis Kapal - Sistem Lelang Ikan TPI</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-md-9">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            ...
                            Input data karcis dari kapal ikan untuk diproses dalam sistem lelang
                        </p>
                    </div>
                ...
                <div class="glass-card p-4">
                    <form id="inputKarcisForm" method="POST" action="<?= site_url('admin/simpan-karcis-kapal') ?>">
                        <div class="row g-4">
                            <!-- Data Kapal -->
                            <div class="col-lg-6">
                                <h5 class="fw-bold mb-3" style="color: #2C3E50; border-bottom: 2px solid #3498DB; padding-bottom: 10px;">
                                    <i class="fas fa-ship me-2"></i> Data Kapal
                                </h5>
                                
                                <div class="mb-3">
                                    <label class="form-label-modern">Nomor Karcis</label>
                                    <input type="text" class="form-control form-control-modern" name="no_karcis" 
                                           value="<?= 'KK-' . date('Ymd') . '-' . rand(1000, 9999) ?>" readonly>
                                    <small class="text-muted">Nomor karcis otomatis di-generate</small>
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label-modern">Nama Kapal <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control form-control-modern" name="nama_kapal" 
                                           value="<?= old('nama_kapal') ?>" required>
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label-modern">Nama Nahkoda</label>
                                    <input type="text" class="form-control form-control-modern" name="nahkoda" 
                                           value="<?= old('nahkoda') ?>">
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label-modern">Jenis Kapal</label>
                                    <select class="form-control form-control-modern" name="jenis_kapal">
                                        <option value="">Pilih Jenis Kapal</option>
                                        <option value="Kapal Pancing" <?= old('jenis_kapal') == 'Kapal Pancing' ? 'selected' : '' ?>>Kapal Pancing</option>
                                        <option value="Kapal Jaring" <?= old('jenis_kapal') == 'Kapal Jaring' ? 'selected' : '' ?>>Kapal Jaring</option>
                                        <option value="Kapal Purse Seine" <?= old('jenis_kapal') == 'Kapal Purse Seine' ? 'selected' : '' ?>>Kapal Purse Seine</option>
                                        <option value="Kapal Gill Net" <?= old('jenis_kapal') == 'Kapal Gill Net' ? 'selected' : '' ?>>Kapal Gill Net</option>
                                        <option value="Kapal Long Line" <?= old('jenis_kapal') == 'Kapal Long Line' ? 'selected' : '' ?>>Kapal Long Line</option>
                                        <option value="Kapal Tradisional" <?= old('jenis_kapal') == 'Kapal Tradisional' ? 'selected' : '' ?>>Kapal Tradisional</option>
                                    </select>
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label-modern">No. Registrasi Kapal</label>
                                    <input type="text" class="form-control form-control-modern" name="no_registrasi" 
                            ...
                            <div class="col-lg-6">
                                <h5 class="fw-bold mb-3" style="color: #2C3E50; border-bottom: 2px solid #3498DB; padding-bottom: 10px;">
                                    <i class="fas fa-fish me-2"></i> Data Tangkapan
                                </h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label-modern">Jumlah Peti</label>
                                        <input type="number" class="form-control form-control-modern" name="jumlah_peti" 
                                               min="0" value="<?= old('jumlah_peti') ?>">
                                    </div>
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label-modern">Daerah Tangkapan</label>
                                    <input type="text" class="form-control form-control-modern" name="daerah_tangkapan" 
                                           placeholder="Contoh: Laut Jawa, Selat Bali, dll" value="<?= old('daerah_tangkapan') ?>">
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label-modern">Tanggal Berangkat</label>
                                    <input type="date" class="form-control form-control-modern" name="tanggal_berangkat" 
                                           value="<?= old('tanggal_berangkat') ?>">
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label-modern">Tanggal Datang <span class="text-danger">*</span></label>
                                    <input type="date" class="form-control form-control-modern" name="tanggal_datang" 
                                           value="<?= old('tanggal_datang') ? old('tanggal_datang') : date('Y-m-d') ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="mb-3">
                                    <label class="form-label-modern">Kondisi Tangkapan</label>
                                    <textarea class="form-control form-control-modern" name="kondisi_tangkapan" rows="2" 
                                              placeholder="Deskripsi kondisi ikan saat ditangkap..."><?= old('kondisi_tangkapan') ?></textarea>
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label-modern">Catatan Tambahan</label>
                                    <textarea class="form-control form-control-modern" name="catatan" rows="2" 
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <label class="form-check-label" for="konfirmasi">
                                        Saya menyatakan bahwa data tangkapan kapal yang diinput adalah benar dan dapat dipertanggungjawabkan
                                    </label>
                                </div>
                            </div>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" class="text-center py-4">
                                            <i class="fas fa-ship fa-2x mb-3" style="color: #ECF0F1;"></i>
                                            <p class="text-muted">Belum ada data kapal yang diinput hari ini</p>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
    ...
    <script>
        ...
        function resetForm() {
            if (confirm('Apakah Anda yakin ingin mereset form? Semua data yang diisi akan hilang.')) {
                ...
                noKarcisField.value = 'KK-' + new Date().toISOString().slice(0,10).replace(/-/g, '') + '-' + 
                                      Math.floor(1000 + Math.random() * 9000);
                
                // Reset tanggal datang ke hari ini
                document.querySelector('[name="tanggal_datang"]').value = new Date().toISOString().slice(0,10);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(() => {
                showNotification('Form input karcis kapal siap digunakan!');
            }, 1000);
        });
    </script>
</body>
