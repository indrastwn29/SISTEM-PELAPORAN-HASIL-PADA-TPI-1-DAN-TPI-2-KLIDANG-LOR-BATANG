...
<head>
    ...
    <title>Data Bakul Terverifikasi - Sistem Lelang Ikan TPI</title>
    <!-- Bootstrap 5 CSS -->
            ...
            <div class="col-lg-10 col-md-9">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h1 class="fw-bold mb-2" style="color: #2C3E50;">
                            <i class="fas fa-check-circle me-3" style="color: #27AE60;"></i>
                            DATA BAKUL TERVERIFIKASI
                        </h1>
                        <p class="text-muted mb-0">
                            <i class="fas fa-info-circle me-2" style="color: #3498DB;"></i>
                            Daftar lengkap data bakul yang sudah diverifikasi dan siap untuk proses lelang
                        </p>
                    </div>
                ...
                <div class="glass-card p-4">
                                ...
                                <tbody>
                                    <?php foreach ($karcis_data as $index => $data): ?>
                                        <tr>
                                            ...
                                            <td><?= $data['nama_bakul'] ?? $data['nama_pedagang'] ?? 'N/A' ?></td>
                                            <td>
                                            ...
                                            <td>
                                                Rp <?= isset($data['harga_per_kg']) ? number_format($data['harga_per_kg'], 0, ',', '.') : '0' ?>
                                            </td>
                                            <td>
                                                <span class="fw-bold text-success">
                                                    Rp <?= isset($data['total_harga']) ? number_format($data['total_harga'], 0, ',', '.') : 
                                                          (isset($data['berat']) && isset($data['harga_per_kg']) ? 
                                                           number_format($data['berat'] * $data['harga_per_kg'], 0, ',', '.') : '0') ?>
                                                </span>
                                            </td>
                                            <td>
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            <div class="mb-4">
                                <i class="fas fa-check-circle fa-4x" style="color: #ECF0F1;"></i>
                            </div>
                            <h4 class="text-muted mb-3">Belum ada data terverifikasi</h4>
                            <p class="text-muted mb-4">Data bakul yang sudah diverifikasi akan muncul di sini</p>
                            <a href="<?= site_url('admin/verifikasi-karcis-bakul') ?>" class="btn btn-modern btn-modern-primary">
                ...
                <div class="mt-4 text-center text-muted">
                    <small>
                        ...
                        <i class="fas fa-check-circle me-1 ms-3"></i>
                        Data Bakul Terverifikasi • 
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Detail Data Bakul</h5>
    ...
    <script>
        ...
        function viewDetail(index) {
            ...
            let detailHtml = `
                <div class="row">
                    <div class="col-md-6">
                        <h6 class="text-muted">Informasi Bakul</h6>
                        <table class="table table-sm">
                            ...
                            <tr>
                                <th>Nama Bakul</th>
                                <td>${item.nama_bakul || item.nama_pedagang || 'N/A'}</td>
                            </tr>
                            <tr>
                                <th>Alamat</th>
                                <td>${item.alamat_bakul || item.alamat || 'Tidak tersedia'}</td>
                            </tr>
                            <tr>
                                <th>Telepon</th>
                                <td>${item.telepon || item.no_telepon || 'Tidak tersedia'}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                        <h6 class="text-muted">Informasi Ikan</h6>
                        <table class="table table-sm">
                            <tr>
                            ...
                            <tr>
                                <th>Harga per Kg</th>
                                <td>Rp ${item.harga_per_kg ? item.harga_per_kg.toLocaleString('id-ID') : '0'}</td>
                            </tr>
                            <tr>
                                <th>Total Harga</th>
                                <td class="fw-bold text-success">
                                    Rp ${item.total_harga ? item.total_harga.toLocaleString('id-ID') : 
                                        (item.berat && item.harga_per_kg ? 
                                         (item.berat * item.harga_per_kg).toLocaleString('id-ID') : '0')}
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <table class="table table-sm">
                            <tr>
                                ...
                                <td>${item.tanggal || item.created_at || 'N/A'}</td>
                            </tr>
                            <tr>
                                <th>Status</th>
                                <td>
            ...
            printWindow.document.write(`
                ...
                <body>
                    <div class="header">
                        ...
                        <h3>KARCIS TERVERIFIKASI</h3>
                        <h4>No: ${noKarcis}</h4>
                    </div>
                    <div class="content">
                        <p>Karcis ini menunjukkan bahwa data telah diverifikasi dan siap untuk proses lelang.</p>
        ...
        function exportToExcel() {
            ...
            link.setAttribute("download", "data_bakul_terverifikasi.csv");
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(() => {
                if (<?= $total_terverifikasi ?> > 0) {
                    showNotification('Data bakul terverifikasi siap ditampilkan!');
                }
            }, 1000);
        });
    </script>
