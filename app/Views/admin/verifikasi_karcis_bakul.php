...
<head>
    ...
    <title>Verifikasi Karcis Bakul - Sistem Lelang Ikan TPI</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
            ...
            <div class="col-lg-2 col-md-3 mb-4">
                <div class="sidebar-modern glass-card p-3">
                    <div class="list-group list-group-flush">
                        ...
                        <!-- Verifikasi Bakul -->
                        <a href="<?= site_url('admin/verifikasi-karcis-bakul') ?>" class="list-group-item list-group-item-action border-0 nav-item-modern mb-2 active">
                            <i class="fas fa-users me-3"></i>
                            <span>Verifikasi Bakul</span>
                            <?php if(isset($total_menunggu) && $total_menunggu > 0): ?>
                                <span class="badge bg-danger float-end"><?= $total_menunggu ?></span>
                            <?php endif; ?>
                        </a>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            ...
                            Verifikasi dan validasi data karcis dari pedagang ikan (bakul) sebelum diproses dalam sistem lelang
                        </p>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="stat-card-modern glass-card p-4" style="border-top: 5px solid #27AE60;">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h3 class="fw-bold mb-1"><?= isset($total_diverifikasi) ? $total_diverifikasi : '0' ?></h3>
                    ...
                    <div class="col-md-4">
                        <div class="stat-card-modern glass-card p-4" style="border-top: 5px solid #E74C3C;">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h3 class="fw-bold mb-1"><?= isset($total_ditolak) ? $total_ditolak : '0' ?></h3>
                ...
                <div class="row mb-4">
                    <div class="col-md-8">
                        <div class="search-box">
                            ...
                            <input type="text" id="searchInput" placeholder="Cari berdasarkan nama bakul, nomor karcis, atau alamat...">
                        </div>
                    </div>
                    <div class="col-md-4">
                            ...
                            <tbody>
                                <?php if (!empty($karcis_data)): ?>
                                    <?php foreach ($karcis_data as $karcis): ?>
                                        ...
                                        $no_karcis = $karcis['no_karcis'] ?? 'KB-' . date('ymd') . '-' . str_pad($karcis_id, 4, '0', STR_PAD_LEFT);
                                        $nama_bakul = $karcis['nama_bakul'] ?? 'N/A';
                                        $alamat = $karcis['alamat'] ?? 'N/A';
                                        $berat_ikan = number_format($karcis['berat_ikan'] ?? 0, 2, ',', '.');
                                        $total = isset($karcis['total']) ? number_format($karcis['total'], 0, ',', '.') : '0';
                                        $tanggal_input = isset($karcis['tanggal_input']) ? date('d/m/Y H:i', strtotime($karcis['tanggal_input'])) : 'N/A';
                                        ?>
                                        <tr>
                                            <td><strong><?= $no_karcis ?></strong></td>
                                            <td><?= $nama_bakul ?></td>
                                            <td><?= $alamat ?></td>
                                            <td><?= $berat_ikan ?> kg</td>
                                            <td>Rp <?= $total ?></td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <form method="post" action="<?= site_url('admin/update-status-bakul') ?>" style="display:inline;">
                                                        <input type="hidden" name="karcis_id" value="<?= $karcis_id ?>">
                                                        <input type="hidden" name="primary_key" value="id_bakul">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="8" class="text-center py-5">
                                            <div class="py-5">
                                                <i class="fas fa-users fa-4x mb-3" style="color: #3498DB; opacity: 0.5;"></i>
                                                <h4 class="mb-3">Tidak ada data karcis bakul</h4>
                                                <p class="text-muted">Belum ada data karcis bakul yang menunggu verifikasi.</p>
                                                <a href="<?= site_url('admin/input-karcis-bakul') ?>" class="btn btn-modern btn-modern-primary">
                                                    <i class="fas fa-plus me-2"></i> Input Karcis Bakul
                                                </a>
                                            </div>
                                        </td>
                                    </tr>
    ...
    <script>
        ...
        function lihatDetail(id) {
            ...
            window.location.href = `<?= site_url('admin/detail-karcis-bakul/') ?>${id}`;
        }
